...
export const metadata = {
  title: "Files.AI - Get a Second Brain with Generative AI",
  description:
    "Files.AI is your second brain in the cloud, designed to easily store and retrieve unstructured information.",
};
